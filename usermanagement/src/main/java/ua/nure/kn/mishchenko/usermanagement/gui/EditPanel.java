...
public class EditPanel extends JPanel implements ActionListener {
	...
	public void fillFields(User user) {
 	...
 	private JPanel getFieldPanel() {
		if(fieldPanel == null) {
			...
			addLabeledField(fieldPanel, ua.nure.kn.mishchenko.usermanagement.gui.Messages.getString("EditPanel.firstName"), getFirstNameField());  //$NON-NLS-1$
			addLabeledField(fieldPanel, ua.nure.kn.mishchenko.usermanagement.gui.Messages.getString("EditPanel.lastName"), getLastNameField());  //$NON-NLS-1$
			addLabeledField(fieldPanel, ua.nure.kn.mishchenko.usermanagement.gui.Messages.getString("EditPanel.dateOfBirth"), getDateOfBirthField());  //$NON-NLS-1$
		}
		return fieldPanel;
	}
	...
	private JButton getOkButton() {
		if (okButton == null){
			...
			okButton.setText(ua.nure.kn.mishchenko.usermanagement.gui.Messages.getString("EditPanel.saveButton"));  //$NON-NLS-1$
	...
	private JButton getCancelButton() {
		if (cancelButton == null){
			...
			cancelButton.setText(ua.nure.kn.mishchenko.usermanagement.gui.Messages.getString("EditPanel.cancelButton"));  //$NON-NLS-1$
